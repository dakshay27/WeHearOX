...
public class ListAdapter extends ArrayAdapter<AvailableDevicesActivity.bluetoothList> {
    public ListAdapter(Context context, ArrayList<AvailableDevicesActivity.bluetoothList> devices) {
...
//                ((ClickPosition)getContext()).clickPos(position);
//            }
//        });
